...
export default function LoginPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const destination = window.document.cookie.includes("muhuze.role=seller") || window.document.cookie.includes("muhuze.role=admin") ? "/dashboard" : "/products";
