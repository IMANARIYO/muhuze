  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[var(--paper)] text-[var(--ink)]">
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 md:grid-cols-[.9fr_1.1fr] md:items-center md:py-24">
            <div className="relative z-10">
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link href="/dashboard/products" className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[var(--ink)] px-6 text-sm font-bold text-white transition-transform hover:-translate-y-0.5">
            ...
            <div className="relative min-h-[390px] sm:min-h-[470px]">
              ...
              <div className="absolute inset-0 overflow-hidden rounded-[28px] border-[10px] border-white bg-[#dce9d7] shadow-[0_24px_60px_rgba(23,33,31,.14)]">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${productVisuals[1].image})` }} />
        ...
        <section id="contact" className="mx-6 mb-20 overflow-hidden rounded-2xl bg-[var(--ink)] text-white sm:mx-auto sm:max-w-6xl"><div className="grid gap-10 px-7 py-12 sm:px-12 md:grid-cols-[1fr_auto] md:items-center md:py-14"><div><p className="text-xs font-bold uppercase tracking-[.16em] text-[#d6f34d]">A little help goes a long way</p><h2 className="mt-3 max-w-xl text-3xl font-black tracking-[-.04em] sm:text-4xl">Have a question about buying or selling?</h2><p className="mt-4 max-w-lg text-sm leading-6 text-[#b7c5bd]">Our team is here to help you make your next move with confidence.</p></div><Link href="/dashboard" className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[#d6f34d] px-6 text-sm font-bold text-[var(--ink)] hover:bg-white">Contact the team <CircleHelp size={17} /></Link></div></section>
      </main>
