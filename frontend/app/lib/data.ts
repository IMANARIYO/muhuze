...
export const navItems: NavItem[] = [
  ...
  { label: "My Wallet", icon: "Wallet", href: "/dashboard/wallet", roles: ["seller"] },
  { label: "My Earnings", icon: "TrendingUp", href: "/dashboard/earnings", roles: ["seller"] },
  ...
  { label: "Platform Wallet", icon: "Wallet", href: "/dashboard/wallet", roles: ["admin"] },
